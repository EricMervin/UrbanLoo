  ...
  return (
    <Box>
      ...
      <Grid container sx={{px: {md: 10, xs: 1}, py: {md: 2, xs: 0}}} spacing={{md: 0, xs: 4}}>
        ...
        <Typography variant="h6" sx={{mb: {md:-2.5, sm: -1.5, xs: -1.5}, textTransform: 'uppercase', fontWeight: '100', mx: 1, fontSize: {md: 36, sm: 27, xs: 27}}}>Secunderabad Railway Station</Typography> <br/>
